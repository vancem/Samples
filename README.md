...
Here are some links to display the HTML files in this repository.  
  ...
  * http://vancem.github.io/Samples/SquareDanceSim6Couple.html - A program to help Square Dance callers call for 6 couples.
    If you are interested in this sample, you should also check out https://github.com/vancem/CallerBuddy (code) and
    https://vancem.github.io/CallerBuddy/ (runable code) which is a program for square dance callers to play
    music and manage lyrics.  
